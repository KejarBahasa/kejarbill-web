...
const messages: Record<string, string> = {
	...
	'expense edit not allowed': 'Kamu tidak memiliki izin untuk mengedit expense ini.',
	'expense locked after settlement': 'Expense tidak bisa diubah karena sudah ada pembayaran.',
	'expense version conflict': 'Expense sudah berubah di tempat lain. Muat ulang data terbaru.',
